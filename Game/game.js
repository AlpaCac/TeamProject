...
function named()
{
    ...
    username=data_game["user_name"];
    // console.log("debuging "+username+" "+data_game["user_name"]);
...
function charb_fyp(i){
    if((i>=2 && i<=4)||(i>=118 && i<133)||(i>=136 && i<=137)){
        var c2 =document.getElementById("character2_fyp");
        c2.style.display="block";
        c2.style.width="240px";
        c2.style.left="900px";
...
j=data_game["now_j"];
if(i=="undefined"||i==0||i==undefined) {i=0;j=0;console.log("!!!"+i);}
